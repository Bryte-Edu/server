...
class FlashcardServiceImpl(val session: Session) : FlashcardService {
    ...
    override suspend fun flashcardsByTopic(topicId: String): List<Flashcard> = flashcards.getByTopicId(topicId)

    override fun flashcards(): Flow<Flashcard> = runBlocking { generator.generateFlashcards() }
}
